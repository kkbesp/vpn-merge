...
> **Из РФ:** для установки зависимостей (Homebrew, Node.js, Deno) нужен временный VPN — `ghcr.io` и другие CDN троттлятся ТСПУ. Используй любой бесплатный VPN для первой установки. После настройки vpn-merge он больше не понадобится.
...
Скрипт:
1. Установит зависимости (Homebrew, Node.js, Deno, wgcf, wrangler)
